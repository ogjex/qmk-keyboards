...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TRNS, KC_TRNS, KC_PSLS, KC_PAST, KC_PMNS,         KC_PEQL, KC_7, KC_8, KC_9, TD(TD_),
    // ----------------------------------------         ---------------------------------------------
    ...
    KC_TRNS, KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U,         KC_NO, KC_NO, KC_NO, KC_NO, KC_BSPC,
    // ----------------------------------------         --------------------------------------------
    KC_TAB, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D,         TD(TD_LSKIP), KC_DOWN, KC_UP, TD(TD_RSKIP), KC_ENT,
    // ----------------------------------------         --------------------------------------------
...
void td_esc_tm(tap_dance_state_t *state, void *user_data) {
    ...
    switch (tap_state.state) {
        case TD_SINGLE_TAP:
            ...
            break;
        case TD_DOUBLE_HOLD:
            SEND_STRING(SS_TAP(X_LCTL) SS_TAP(X_LALT) SS_TAP(X_DELT));
            break;
        default:
            break;
    }
